...
if (!empty($_POST["btneditar"])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $id_categoria = filter_input(INPUT_POST, 'id', FILTER_SANITIZE_STRING);
        $nombre_categoria = filter_input(INPUT_POST, 'nombre_categoria', FILTER_SANITIZE_STRING);
        $descripcion_categoria = filter_input(INPUT_POST, 'descripcion_categoria', FILTER_SANITIZE_STRING);
        $conn = conn();
    ...
    // Verificar la conexión
        ...
        $sql = "UPDATE guia_categoria SET nombre_categoria = ?, descripcion_categoria = ? WHERE id_categoria = '$id_categoria';";
