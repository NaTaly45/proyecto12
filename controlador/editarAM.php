...
if (!empty($_POST["btneditar"])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $id_ambiente = filter_input(INPUT_POST, 'id_ambiente', FILTER_SANITIZE_NUMBER_INT);
    ...
    // Verificar la conexión
        ...
        $sql = "UPDATE guia_ambiente SET nombre_ambiente = ?, ubicacion_ambiente = ?, descripcion_ambiente = ?, categoria_ambiente = ?, piso_ambiente = ?, encargado_ambiente = ?, img_ambiente = ? WHERE id_ambiente = ?;
";
        ...
        if ($stmt->execute()) {
            ...
            Ambiente editado correctamente.
            </div>
