...
if (!empty($_POST["btneditar"])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $id_piso = filter_input(INPUT_POST, 'id', FILTER_SANITIZE_STRING);
    ...
    // Verificar la conexión
        ...
        $sql = "UPDATE guia_piso SET lugar = ?, descripcion_piso = ? WHERE id_piso = '$id_piso'";
