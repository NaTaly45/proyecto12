...
if (!empty($_POST["btnregistrar"])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $ci_encargado = filter_input(INPUT_POST, 'ci_encargado',  FILTER_SANITIZE_NUMBER_INT);
    ...
    // Verificar la conexión
        ...
        $sql = "INSERT INTO guia_encargado (ci_encargado, nombres_encargado, apellido_p_encargado, apellido_m_encargado, celular_encargado) VALUES (?, ?, ?, ?, ?)";
        ...
        if ($stmt->execute()) {
            ...
            Encargado insertada correctamente
            </div>
